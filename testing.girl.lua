...
function onmonkey()
  ...
  if status <= 1 then
    existl:incmk(T34.new("1m"), -999)
    existc:incmk(T34.new("1m"), -999)
    existr:incmk(T34.new("1m"), -999)
    existl:incmk(T34.new("4m"), -999)
    existc:incmk(T34.new("4m"), -999)
    existr:incmk(T34.new("4m"), -999)
    existl:incmk(T34.new("7m"), -999)
    existc:incmk(T34.new("7m"), -999)
    existr:incmk(T34.new("7m"), -999)
    existself:incmk(T34.new("1m"), -999)
    existself:incmk(T34.new("4m"), -999)
    existself:incmk(T34.new("7m"), -999)
  end

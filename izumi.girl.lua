...
function checkinit()
  ...
  if status <= 1 then
    return init:step() >= 3 and init:step() <= 4 and init:step7() <= 3 and init:ct(T34.new("1y")) == 2
  end

  if status == 2 then
    return init:step() >= 3 and init:step() <= 4 and init:step7() <= 3 and init:ct(T34.new("2y")) == 2
  end

  if status == 3 then
    return init:step() >= 3 and init:step() <= 4 and init:step7() <= 3 and init:ct(T34.new("3y")) == 2
  end

  if status == 4 then
    if sw == 1 then
      return init:step() >= 3 and init:step() <= 4 and init:step7() <= 3 and init:ct(T34.new("1f")) == 2
    end
    if sw == 2 then
      return init:step() >= 3 and init:step() <= 4 and init:step7() <= 3 and init:ct(T34.new("2f")) == 2
    end
    if sw == 3 then
      return init:step() >= 3 and init:step() <= 4 and init:step7() <= 3 and init:ct(T34.new("3f")) == 2
    end
    if sw == 4 then
      return init:step() >= 3 and init:step() <= 4 and init:step7() <= 3 and init:ct(T34.new("4f")) == 2
    end
  end
